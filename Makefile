...
client npm update:
	cd ~/Developer/levi/client && npm update && cd ..
...
ide:
	docker-compose exec php php artisan ide-helper:generate; docker-compose exec php php artisan ide-helper:actions; docker-compose exec php php artisan ide-helper:models --nowrite; docker-compose exec php php artisan ide-helper:meta
